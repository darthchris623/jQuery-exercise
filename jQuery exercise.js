console.log('jQuery exercise'); // Just for my own reference
...
/*
2. Give all images inside of an article tag the class of
image-center (this class is defined inside of the style
tag in the head).
*/
...
$('ol').append($('<li>', { text: 'Welcome to jQuery.' }));

/* 
6. Scratch that; the list is silly. Empty the aside and put
a paragraph in it apologizing for the list’s existence.
*/

$('aside').empty();
const $newParagraph = $('<p>I\'m sorry for that list.</p>').appendTo('aside');
